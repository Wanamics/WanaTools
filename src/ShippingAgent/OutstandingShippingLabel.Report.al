report 87112 "wan Outstanding Shipping Label"
{
    ApplicationArea = Warehouse;
    // UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = './Layout/OutstandingShippingLabel.rdl';
    Caption = 'Outstanding Shipping Label';
    ...
    dataset
    {
        dataitem(SalesShipmentHeader; "Sales Shipment Header")
        {
            ...
            column(OrderNumber_Code128; Encode1D(SalesShipmentHeader."Order No.", "Barcode Symbology"::Code128)) { }

            column(OrderNumber_QRCode; Encode2D(SalesShipmentHeader."Order No.", "Barcode Symbology 2D"::"QR-Code")) { }
